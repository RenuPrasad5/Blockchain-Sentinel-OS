                                            ...
                                            <div className="flex justify-between items-start mb-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">CRYPTO-WORLD FORENSICS v2.0</span>
                                                    </div>
                                                </div>
                                                <div className="text-right">
                                                    <div className="text-[9px] text-slate-500 uppercase font-black">Report Serial No.</div>
                                                    <div className="text-xs text-white font-mono">CW-FX-2026-X84-001</div>
                                                </div>
                                            </div>
