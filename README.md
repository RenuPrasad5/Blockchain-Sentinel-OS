...
### **[ INTELLIGENCE UPLINK ]**
- **Data Ingestion:** `Alchemy SDK` (High-Frequency WebSockets) for real-time mempool interception.
- **Forensic Logic:** `Ethers.js v6` with custom forensic decoding layers.
- **Backend:** `Firebase` (Encrypted Auth, Firestore Database, and Forensic Asset Storage).
- **Engine:** `ForensicEngine.js` (Proprietary AML/Risk logic).
